...
\033[1;93m
\033[1;92m
\033[1;93m           L O O S E R 
\033[1;94m
\033[1;93m
\033[1;91m
-----------------------------------------------
  AUTHER   :::     ALEY X RITI BRO X SIS
 FACEBOOK  :::     ALEY KASHAN
 QUEEN     :::     RITI
    QUEEN OF FACEBOOK RITI
-----------------------------------------------"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/aleykashan/PAPA/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://www.facebook.com/100022645551442.75.2021')
        reg()
